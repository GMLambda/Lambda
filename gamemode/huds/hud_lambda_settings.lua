...
function PANEL_CROSSHAIR:Init()
    ...
    local quickinfo = self:Add("DCheckBoxLabel")
    quickinfo:SetPos(dyn_cross:GetWide() + 10, 5)
    quickinfo:SetText("Default Half-Life 2 / QuickInfo")
    quickinfo:SetConVar("lambda_quickinfo")
    quickinfo:SetValue(cvars.Number("lambda_quickinfo"))
