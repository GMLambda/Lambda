...
local function CreateFonts()
	surface.CreateFont(font, {font = "Tahoma", size = util.ScreenScaleH(7), weight = 800, antialias = true, additive = false})
	surface.CreateFont("LambdaKillico", {font = "HL2MP", size = util.ScreenScaleH(22), weight = 100, antialias = true, additive = false})
