...
SKIN.bg_color					= Color( 0, 0, 0, 128 )
SKIN.bg_color_sleep				= Color( 70, 70, 70, 128 )
SKIN.bg_color_dark				= Color( 55, 57, 61, 128 )
SKIN.bg_color_bright			= Color( 220, 220, 220, 128 )
SKIN.frame_border				= Color( 50, 50, 50, 255 )

SKIN.fontFrame					= "DermaDefault"

SKIN.control_color				= Color( 0, 0, 0, 255 )
...
SKIN.bg_alt1					= Color( 50, 50, 50, 128 )
...
SKIN.colPropertySheet			= Color( 170, 170, 170, 128 )
...
SKIN.tex.CheckBoxNew 				= Material( "lambda/icons/tick.png", "noclamp smooth" )
SKIN.tex.SortUpNew					= Material( "lambda/icons/sort2.png", "noclamp smooth")
SKIN.tex.SortDownNew				= Material( "lambda/icons/sort3.png", "noclamp smooth")
...
function SKIN:PaintCheckBox( panel, w, h )
    ...
    if (panel:GetChecked()) then
        ...
        surface.SetMaterial(SKIN.tex.CheckBoxNew)
...
function SKIN:PaintTextEntry( panel, w, h )
	...
	surface.SetDrawColor(Color(255,255,255,155))
   	...
   	-- Just gonna override with white here because
	panel:DrawTextEntryText( Color(255,255,255,255), panel:GetHighlightColor(), panel:GetCursorColor() )
...
derma.DefineSkin( "Lambda", "Lambda", SKIN )
