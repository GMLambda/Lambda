...
local Color = Color
SKIN = {}
SKIN.PrintName = "Lambda"
SKIN.Author = ""
SKIN.DermaVersion = 1
SKIN.GwenTexture = Material("lambda/uiskin.png")
...
SKIN.text_normal2 = Color(180, 180, 180, 255)
...
SKIN.colTabTextInactive = Color(0, 0, 0, 100)
...
function SKIN:PaintMenuOption(panel, w, h)
    ...
    panel:SetTextColor(Color(255, 255, 255, 155))
end
...
function SKIN:PaintCollapsibleCategory(panel, w, h)
    if h < 21 then return self.tex.CategoryList.Header(0, 0, w, h) end
...
derma.DefineSkin("Lambda", "Custom skin based on default derma", SKIN)