...
function MAPSCRIPT:PostInit()
    if SERVER then
        ...
        trigger1:SetupTrigger(Vector(-4059.708252, 54.849800, -10.067627), Angle(0, 0, 0), Vector(-100, -800, 0), Vector(100, 800, 280))

        trigger1.OnTrigger = function()
            TriggerOutputs({{"dock_soldier_template", "ForceSpawn", 0.0, ""}, {"dock_soldier_template", "Kill", 0.1, ""}, {"dock_antlion_spawner", "Spawn", 0.2, ""}, {"dock_spawn", "ForceSpawn", 0.0, ""}, {"ontherun_begin_assault", "Activate", 0.5, ""}})
            -- Few extra npcs
            local npc
        ...
        bridgeKillTrigger:SetupTrigger(Vector(-1835.606934, 1068.328979, 669.459900), Angle(0, 0, 0), Vector(-400, -350, 0), Vector(400, 350, 100))
