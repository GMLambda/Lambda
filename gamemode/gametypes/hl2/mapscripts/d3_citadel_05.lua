...
function CreatePOD(bayname)
    ...
    func_door_rotating:SetNotSolid(true)
...
function MAPSCRIPT:PostInit()
    ...
    if SERVER then
        ...
        podCreateTrigger:SetupTrigger(
            Vector(1005.086487, -512.151855, -3000.966553),
            Angle(0, 0, 0),
            Vector(-20, -50, 0),
            Vector(20, 50, 200)
        )
        ...
        cameraTrigger:SetupTrigger(
            Vector(936.5, -512, -3002),
            Angle(0, 0, 0),
            Vector(-10, -50, 0),
            Vector(10, 50, 200)
        )
