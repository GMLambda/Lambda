...
function MAPSCRIPT:PostInit()
    if SERVER then
        ...
        checkpointTrigger1:SetupTrigger(Vector(-7763.793945, -6373.333496, 10.588013), Angle(0, 0, 0), Vector(-3400, -1050, -100), Vector(2200, 1750, 300))

        checkpointTrigger1.OnEndTouchAll = function(trigger)
            TriggerOutputs({{"relationship_soldiers_vs_dog_like", "RevertRelationship", 0, ""}, {"pclip_gate1", "Enable", 0, ""}, {"lcs_dog_nag_door_loop1", "Cancel", 0, ""}, {"lcs_dog_nag_door_loop1", "Kill", 0.10, ""}, {"relationship_soldiers_vs_dog_hate", "ApplyRelationship", 0.20, ""}, {"logic_dropshipStart", "Trigger", 1.00, ""}, {"ss_dog_ThruGate", "BeginSequence", 2.50, ""}, {"sound_dog_surprised_1", "PlaySound", 4.00, ""}, {"sound_dog_roar_1", "PlaySound", 6.00, ""}})
            trigger:Remove()
