...
function MAPSCRIPT:PostInit()
    if SERVER then
        ...
        GAMEMODE:WaitForInput("brush_soda_clip_player_2", "Enable", function(ent)
            if allowPlayerClip == false then return true end -- Suppress
        end)
        ...
        doorTrigger:SetupTrigger(Vector(-6754.733398, -1360.082764, 0.031250), Angle(0, 0, 0), Vector(-350, -300, 0), Vector(400, 200, 180))
        ...
        suitTrigger:SetupTrigger(Vector(-6716.156250, -1396.862793, 0), Angle(0, 0, 0), Vector(-350, -300, 0), Vector(350, 310, 250), true, SF_TRIGGER_ONLY_PLAYER_WITH_HEV)
        ...
        if IsValid(itemSuit) then
            ...
            newSuit.EntityOutputs = {
                ["OnPlayerTouch"] = {"song_suit,PlaySound,,0,-1", "lambda_suit_trigger,Enable,,0,-1"}
            }
