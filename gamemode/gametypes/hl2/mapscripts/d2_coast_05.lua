...
function MAPSCRIPT:PostInit()
    if SERVER then
        ...
        checkpointTrigger1:SetupTrigger(Vector(-4097.192871, -12543.278320, 704.031250), Angle(0, 0, 0), Vector(-100, -250, 0), Vector(100, 250, 280))

        checkpointTrigger1.OnTrigger = function(_, activator)
            GAMEMODE:SetVehicleCheckpoint(Vector(-4308.972656, -12341.547852, 706.201477), Angle(0, 90, 0))
            GAMEMODE:SetPlayerCheckpoint(checkpoint1, activator)
            TriggerOutputs({{"house_secondwave", "ForceSpawn", 0.0, ""}, {"secondwave_assault", "Activate", 1.0, ""}, {"secondwave_assault", "BeginAssault", 3.0, ""}, {"house_secondwave", "Kill", 4.0, ""}}) -- Don't trigger again
        end
        ...
        checkpointTrigger2:SetupTrigger(Vector(-4863.671875, -3216.657471, 1088.031250), Angle(0, 0, 0), Vector(-300, -50, 0), Vector(300, 50, 280))
