...
function MAPSCRIPT:PostInit()
    if SERVER then
        ...
        npcMaker1:SetKeyValue("MaxNPCCount", "2")
        npcMaker1:SetKeyValue("MaxLiveChildren", "1")
        npcMaker1:SetKeyValue("StartDisabled", "1")
        npcMaker1:SetKeyValue("NPCSquadName", "Overwatch")
        npcMaker1:SetKeyValue("EnableScaling", "1")
        npcMaker1:SetSpawnFlags(SF_NPCMAKER_HIDEFROMPLAYER)
        npcMaker1:Spawn()

        local npcMaker2 = ents.Create("npc_maker")
        npcMaker2:SetPos(Vector(-3817.560547, 9669.485352, 288.031250))
        ...
        npcMaker2:SetKeyValue("EnableScaling", "1")
        npcMaker2:SetName("lambda_npc_maker2")
        npcMaker2:Spawn()

        ents.WaitForEntityByName("gallerycop_maker1", function(ent)
            ent:SetKeyValue("EnableScaling", "1")
        end)
        ents.WaitForEntityByName("gallerycop_maker2", function(ent)
            ent:SetKeyValue("EnableScaling", "1")
        end)
        ents.WaitForEntityByName("gallerycop_maker3", function(ent)
            ent:SetKeyValue("EnableScaling", "1")
        end)
        ents.WaitForEntityByName("gallerycop_maker4", function(ent)
            ent:SetKeyValue("EnableScaling", "1")
        end)
        ...
        npcMaker3:SetKeyValue("MaxNPCCount", "4")
        ...
        npcMaker3:SetKeyValue("EnableScaling", "1")
